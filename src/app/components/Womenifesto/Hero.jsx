      ...
      <div className="relative z-10 xl:max-w-5xl mx-auto px-6 text-white">
        ...
        <div className="bg-black/55 p-2 md:px-5 md:py-9  rounded-3xl flex-col flex">
          ...
          <p className="text-lg  leading-relaxed text-center md:text-start  text-gray-200">
            ...
            communal piece that reflected Lahore&apos;s diverse cultural identity.
            Rooted in the city&apos;s history and symbolism of YMCA as a place of
            inclusivity, the installation wove together three overarching
            narratives: Kaun (Who?) — personal stories, Kahan (Where?) —
            intergenerational stories, and Kyun (Why?) — political stories.
            Through this communal fabric, Kiran Khan emphasized textiles as
            carriers of memory, history, and resilience, stitching together
            individual voices into a collective social identity.
          </p>
        </div>
      </div>
    </section>
