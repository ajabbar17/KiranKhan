...
export default function Awards() {
  ...
  return (
    <section className="w-full  py-20 flex flex-col items-center text-white">
      ...
      style={{ backgroundImage: "url('/awards.webp')" }}>
        <div className="relative flex xl:flex-row flex-col w-auto xl:max-w-5xl overflow-hidden  gap-10 items-center ">
          {/* Left Content */}
          <AnimatePresence mode="wait">
            ...
            >
              <h3 className="font-bold text-2xl  mb-10">{awardsData[index].date}</h3>
